    ...
    <div className="container mx-auto bg-[#21211e] pb-5">
      ...
      <div className="flex">
        ...
        <div className="w-1/2 pl-158px pt-14">
          ...
          <p className="text-white text-xl Light pl-2">
          ...
          <p className="text-white text-xl Regular pl-32 pt-6">
